...
class TestblogModel:
    def test_blog_creation(self, default_blog):
        ...
        assert isinstance(blog.author, User), "author is not a User instance"
        assert blog.blog_slug == "test-blog"
        assert blog.created_date is not None, "created_date is not set"
        assert blog.updated_date is not None, "updated_date is not set"
...
class TestTagModel:
    def test_tag_creation(self, tag):
        ...
        assert tag.created_date is not None, "created_date is not set"
        assert tag.updated_date is not None, "updated_date is not set"
